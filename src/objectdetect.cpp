...
ObjectDetect::ObjectDetect()
{
    ...
    classesFile = "/team417/data/objects.names";
    modelConfiguration = "/team417/data/objects-yolov3-tiny.cfg";
    modelWeights = "/team417/data/objects-yolov3-tiny_10000.weights";
